...
class DeathMatchGame(bs.TeamGameActivity[Player, Team]):
    ...
    def get_available_settings(
        ...
        settings = [
            ...
            bs.BoolSetting('Go super', default=True),
    ...
    def __init__(self, settings: dict):
        ...
        self._go_super = bool(settings['Go super'])
    ...
    def get_instance_description(self) -> str | Sequence:
        ...
        return 'Parry ${ARG1} stuff', self._score_to_win

    @override
    def get_instance_description_short(self) -> str | Sequence:
        # (Pylint Bug?) pylint: disable=missing-function-docstring

        return 'parry ${ARG1} thing', self._score_to_win
    ...
    def spawn_player(self, player):
        ...
        if self._go_super:
            spaz.gosuper(True)
        # make us like 10 hp tho
        spaz.hitpoints_max = 100
    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        elif isinstance(msg, ParryMessage):
